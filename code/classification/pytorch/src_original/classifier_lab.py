...
config['dataset_name'] = 'lab'
config['data_path'] = '/fs/neurosci01/visitors/jiahongo/longitudinal_prediction/data/LAB/'
...
config['loss_ratios'] = [1.2, 1.0]    # C vs E+HE, single ts
#config['loss_ratios'] = [0.71, 0.87]    # C vs E+HE, multiple ts
...
config['pretrained_path'] = '/fs/neurosci01/visitors/jiahongo/longitudinal_prediction/ckpt/lab/SingleTimestep3DCNN/2020_2_29_20_25/epoch043.pth.tar'    # single, C vs E+HE, fold 0
